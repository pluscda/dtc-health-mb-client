...
const items = ["何杰金氏淋巴瘤", "非何杰金氏淋巴瘤", "肉瘤", "骨癌", "皮膚癌", "黑色素瘤", "白血病", "多發性骨髓瘤"].map((s, i) => ({
  src: s,
  text: strs[i],
}));
export default {
